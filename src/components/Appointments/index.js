...
export default function Appointment(props) {    
    ...
    return (
        <article className="appointment"  data-testid="appointment">
            ...
            {mode === ERROR_SAVE && <Error errorMessage="Could Not Book Appointment" onClose={back} />}
            {mode === ERROR_DELETE && <Error errorMessage="Could Not Delete Appointment" onClose={back} />}
        </article>
    )
}